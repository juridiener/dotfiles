...
luafile ~/.config/nvim/plug-config/lua/nvim-webdev-icons.lua
...
luafile ~/.config/nvim/plug-config/lua/nvim-tree.lua
luafile ~/.config/nvim/plug-config/lua/comment.lua
